DeleteParcentricity=function(manager,microDefault)
{
	...
	this.setTitleDialogMacro=function()
	{
		...
		label.innerHTML="Delete Parcentricity";		
	...
	{	
		...
		this.labelContent.innerHTML="Do you want delete parcentricity for micro "+this.currentMicro+"?";
...
DeleteParcentricity.prototype.delete=function(event,me)
{
	var callback = {
	  success: function(o) {
	...
	var url='admin/cgi-bin/micro.cgi?ACTION=deleteparcentricity';
	url+="&micro="+me.currentMicro;
	me.show_progress_bar();
	var cObj = YAHOO.util.Connect.asyncRequest('GET', url, callback);
}

DeleteParcentricity.prototype.setMicro=function(micro)
{
	this.currentMicro=micro;
	this.labelContent.innerHTML="Do you want delete parcentricity for micro "+this.currentMicro+"?";
}
DeleteParcentricity.prototype.getButtons=function()
{
