...
public class Particles4_ implements PlugInFilter {
	...
	public int setup(String arg, ImagePlus imp) {
		...
		gd.addMessage("Particles4_ v2.12 by G. Landini");
...
void stats(int nc, Vector vg, float [] pars){
	...
	void showAbout() {
		IJ.showMessage("About Particles4_...",
		"Particles4_ by Gabriel Landini,  G.Landini@bham.ac.uk\n"+
		"ImageJ plugin for estimating various statistics of 4-connected particles.\n"+
		...
		"Here, particles are 4-connected while the the Analyze Particles considers\n"+
		"8-connected. In addition, here  \'Perimeter\' & \'Area\' are measured based \n"+
		"on the polygon given by the centres of the boundary pixels.\n"+
		"\'Area\' disregards \'holes\' in the particles (i.e. it returns the area inside the \n"+
		"boundary), but \'Pixels\' does not.\n"+
