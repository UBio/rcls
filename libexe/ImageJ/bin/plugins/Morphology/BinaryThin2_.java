...
public class BinaryThin2_ implements PlugInFilter {
	...
	public int setup(String arg, ImagePlus imp) {
		...
		GenericDialog gd = new GenericDialog("Binary Thin2", IJ.getInstance());
		gd.addMessage("Binary Thin using 2 kernels v1.0");
