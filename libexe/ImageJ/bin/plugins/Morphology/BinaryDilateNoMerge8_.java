...
public class BinaryDilateNoMerge8_ implements PlugInFilter {
	...
	public int setup(String arg, ImagePlus imp) {
		...
		GenericDialog gd = new GenericDialog("BinaryDilateNoMerge8", IJ.getInstance());
		gd.addMessage("Binary dilation without merging v2.2");
		gd.addMessage("8-connected");
		gd.addMessage("This can be really slow...");
...
//		//binarise
	...
	void showAbout() {
		IJ.showMessage("About BinaryDilateNoMerge8_...",
		"BinaryDilateNoMerge8_ by Gabriel Landini,  G.Landini@bham.ac.uk\n"+
		"ImageJ plugin for morphological dilation (8 neighbours) of a binary image\n"+
		"without merging.\n"+
